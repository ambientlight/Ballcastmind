...
class Conv2dMaxpool6xDenseDenseHeads7(ModelDescriptor):
    _version = 0
    ...
    def create_model(self, space: Optional[Dict[str, Any]] = None) -> Model:
        ...
        pos_x_dense = layers.Dense(512, activation='relu')(x)
        pos_y_dense = layers.Dense(512, activation='relu')(x)
        pos_z_dense = layers.Dense(512, activation='relu')(x)
        rot_x_dense = layers.Dense(512, activation='relu')(x)
        rot_y_dense = layers.Dense(512, activation='relu')(x)
        rot_z_dense = layers.Dense(512, activation='relu')(x)
        fov_dense = layers.Dense(512, activation='relu')(x)
    ...
    def data_generator(self, data_locators: Sequence[Any], batch_size: int) -> Generator:
        ...
        while 1:
            ...
            while read_count < (len(target_samples) - batch_size):
                ...
                xs = numpy.array([Conv2dMaxpool6xDenseDenseHeads7.frame_sample_load_image(frame_sample, target_size)
